...
@TeleOp(name="meccDrive w/ toggle", group="Linear Opmode")
//@Disabled
public class meccDrive_with_toggle extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            //Toggle mode (which brandon doesn't want now) (it's 4 me now :))
